...
var DatePicker = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var hideDateDisplay = _props.hideDateDisplay;
    ...
    var other = _objectWithoutProperties(_props, ['container', 'DateTimeFormat', 'locale', 'wordings', 'autoOk', 'defaultDate', 'formatDate', 'maxDate', 'minDate', 'mode', 'hideDateDisplay', 'onDismiss', 'onFocus', 'onShow', 'onTouchTap', 'disableYearSelection', 'style', 'textFieldStyle', 'valueLink', 'firstDayOfWeek']);
